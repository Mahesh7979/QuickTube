...
export default function Home() {
  ...
  const [aiModel, setAiModel] = useState<"gemini" | "groq" | "gpt4">("gemini")
  ...
  return (
    <div className="h-full bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-3xl font-bold text-center">QuickTube</CardTitle>
          <CardDescription className="text-center">Enter a YouTube URL to get summary</CardDescription>
        </CardHeader>
        <CardContent>
